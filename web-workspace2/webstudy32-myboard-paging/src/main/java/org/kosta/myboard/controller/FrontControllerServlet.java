...
public class FrontControllerServlet extends HttpServlet {
	...
	public boolean checkLogin(HttpServletRequest request,String command) {
		...
		//인증이 필요한 컨트롤러이고 세션이 null 또는 세션안의 mvo 가 null 이면 
		if(permitAllList.contains(command)==false && (session == null || session.getAttribute("mvo")==null)) { //ListController 나 LoginController 가 아니면
