...
public class BoardDAO {
	...
	public void writePost(PostVO pvo) throws SQLException{
		Connection con =  null;
		PreparedStatement pstmt = null;
		try {
			con = dataSource.getConnection();
			...
			pstmt.setString(3, pvo.getMemberVO().getId());
			pstmt.executeUpdate();
		}finally{
	...
	public void updatePostByNo(PostVO pvo) throws SQLException {
		Connection con = null;
		PreparedStatement pstmt = null;
		try {
			con = dataSource.getConnection();
