...
insert into board_member values('java','a','아이유');
insert into board_member values('jsp','b','이강인');
insert into board_member values('spring','c','강하늘');

select id,password,name from board_member;
...
select b.no,b.title,b.content,b.hits,to_char(b.time_posted,'yyyy.mm.dd'),m.name
