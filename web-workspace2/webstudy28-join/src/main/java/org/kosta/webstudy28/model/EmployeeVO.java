...
public class EmployeeVO {
	...
	private DepartmentVO departmentVO; //has a 관계
	public EmployeeVO() {
		super();
	}
	...
	public EmployeeVO(int empno, String ename, int sal, String dname, String loc) {
		this.empno = empno;
		this.ename = ename;
		this.sal = sal;
		departmentVO.setDname(dname);
		departmentVO.setLoc(loc);
	}
	public int getEmpno() {
		return empno;
	}
