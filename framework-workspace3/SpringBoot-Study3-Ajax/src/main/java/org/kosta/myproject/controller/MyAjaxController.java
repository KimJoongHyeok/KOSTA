...
public class MyAjaxController {
	...
	@ResponseBody //DTO or VO 로 리턴하면 JSONObject로 응답한다 ( jackson data bind 라이브러리에 의해 )
	...
	@ResponseBody	//jackson databind 에 의해 JSONArray > JSONObject 안에 
	...
	@ResponseBody	//map을 JSONObject 로 생성해서 응답한다.
