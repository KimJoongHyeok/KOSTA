...
<html>
	<head>
		...
		<script type="text/javascript">
			//id createBtn 버ㅡㄴ을 클릭하면 testDiv id div 영역에 동적으로 버튼을 생성한다.
			$(document).ready(function() {
				...
				//방식의 이벤트처리는 동작되지 않는다 -> 동적으로 생성되는 요소에 대한 이벤트 처리는 jquery on으로 처리한다
				/* $(".testBtn").click(function(){
					alert($(this).val());
				}); */
				
				//DOM load(document ready) 시점에 존재하지 않는, 동적으로 생성되는 요소에 대한 이벤트 핸들링(처리)은 
				//jquery on 함수로 처리
