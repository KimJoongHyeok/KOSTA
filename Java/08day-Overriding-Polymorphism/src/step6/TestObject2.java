package step6;
// 모든 자바 클래스의 최상위 부모 클래스의 java.lang.Object의 toString() 를 확인하고 , 오버라이딩 해보는 예제
class Food{
...
public class TestObject2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(f1); //println 메서드에서 참조형 데이터 즉 객체가 전달되면 내부적으로 toString을 호출한 값을 출력
		Food f2 = new Food();
		System.out.println(f2.toString());
		System.out.println(f2); //toString() 을 호출하지 않아도 println() 메서드 내부적으로 호출하여 값을 출력, 결과적으로 동일
		System.out.println("*******Object의 toString()을 오버라이딩해서 테스트 해본다***********");
