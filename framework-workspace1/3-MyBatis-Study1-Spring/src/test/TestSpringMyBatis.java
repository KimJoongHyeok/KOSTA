...
public class TestSpringMyBatis {
	public static void main(String[] args) {
		...
		/*
		 * AccountDAO dao=(AccountDAO)ctx.getBean("accountDAOImpl"); //String id="1";
		 * //System.out.println(dao.findAccountById(id)); dao.registerAccount(new
		 * AccountVO("3","손흥민",2000)); List<AccountVO> list=dao.getAllAccountList();
		 * for(AccountVO vo:list) System.out.println(vo);
		 */
		...
		*/
		//4. 이름과 주소로 회원리스트 조회 ( 검색어가 여러개 일 경우 )
