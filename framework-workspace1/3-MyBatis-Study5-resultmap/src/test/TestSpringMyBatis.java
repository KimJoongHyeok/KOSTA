...
public class TestSpringMyBatis {
	public static void main(String[] args) {
		...
		//DirectorVO directorVO = new DirectorVO("봉준호","아카데미 수상");
		DirectorVO directorVO = new DirectorVO("고레에다","칸 수상");
		mapper.registerDirector(directorVO);
		System.out.println(directorVO + "감독 등록완료");
